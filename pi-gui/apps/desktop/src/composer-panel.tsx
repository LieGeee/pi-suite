...
import { ArrowUpIcon, PlusIcon, SparkIcon, StopSquareIcon } from "./icons";
import type {
...
interface ComposerPanelProps {
  ...
  readonly onToggleWebPreview?: () => void;
  readonly onSubmit: () => void;
  readonly onRunDevelopmentOrchestration: () => void;
    ...
    <footer className="composer">
      <div className="conversation conversation--composer">
        <ComposerSurface
          ...
          textareaPlaceholder="让 pi 帮你检查仓库、修复问题，或继续当前对话..."
              ...
              <div className="composer__footer-row">
                <div className="composer__hint">
                  ...
                  {selectedSession.status === "running"
                    ? `${runningLabel} · 回车加入队列 · Cmd+Enter 立即插话`
                    : "回车发送 · Shift+Enter 换行"}
                  {" · "}
                  <ModelSelector
                    runtime={runtime}
                ...
                <div className="composer__actions">
                  {appMode === "development" && activeDevelopmentModePresetId ? (
                    <button
                      aria-label="运行开发编排"
                      className="icon-button composer__attach"
                      type="button"
                      disabled={selectedSession.status === "running"}
                      onClick={onRunDevelopmentOrchestration}
                      title="运行开发编排"
                    >
                      <SparkIcon />
                    </button>
