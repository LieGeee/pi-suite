...
export interface AppStoreInternals {
  ...
  setSidebarTab(sidebarTab: SidebarTab): Promise<DesktopAppState>;
  setAppearanceTheme(appearanceTheme: AppearanceThemeId): Promise<DesktopAppState>;
  ...
  reloadTranscriptFromDriver(sessionRef: SessionRef, options?: { readonly fromDisk?: boolean }): Promise<void>;
