          ...
          <>
            ...
            <div className="tree-modal__footer">
              <div className="tree-modal__hint">
                选择用户提问会把它重新放回输入框；选择其他节点则会直接跳转过去。
              </div>
        ...
        {!loading && tree && step === "summary" ? (
          <div className="tree-modal__summary-step" data-testid="tree-summary-step">
            <div className="tree-modal__summary-copy">
              你即将离开当前分支。请选择在切换前，是否要让 pi 为当前分支生成摘要。
            </div>
            <div className="tree-summary-options">
              ...
              >
                ...
                <span className="tree-summary-option__description">直接跳转，不保留当前分支摘要。</span>
              </button>
              <button
              ...
              >
                ...
                <span className="tree-summary-option__description">切换前先为当前分支生成摘要。</span>
              </button>
              <button
              ...
              >
                <span className="tree-summary-option__title">自定义摘要提示词</span>
                <span className="tree-summary-option__description">为摘要补充额外说明。</span>
              </button>
            </div>
            ...
            {summaryMode === "custom" ? (
              <textarea
                ...
                placeholder="例如：重点总结关键决策、变更文件和未解决风险。"
