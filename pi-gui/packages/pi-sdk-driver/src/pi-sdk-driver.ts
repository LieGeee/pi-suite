...
import {
  generateDockComponentDefinition as generateDockComponentDefinitionWithAgent,
} from "./component-generator.js";
import type { DockComponentDefinition, DockComponentGenerationInput } from "./component-manifest.js";
...
export class PiSdkDriver implements SessionDriver {
  ...
  createTransientSession(workspace: WorkspaceRef, options?: CreateSessionOptions): Promise<SessionSnapshot> {
    return this.supervisor.createTransientSession(workspace, options);
  }
  ...
  reloadTranscriptFromDisk(sessionRef: SessionRef) {
    return this.supervisor.reloadTranscriptFromDisk(sessionRef);
  }

  generateDockComponentDefinition(input: DockComponentGenerationInput): Promise<DockComponentDefinition | null> {
    return generateDockComponentDefinitionWithAgent(input, {
